                  ...
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          String formatDMY(String waktu) {
                            var dateTime = DateTime.parse(waktu);
                            var formattedDate =
                            ...
                            child: ListTile(
                              ...
                              leading: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    formatDMY(controller.todoItems[index].waktu.toString()),
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                (controller.isLoadingBtn.value) ? () {} : controller.simpan();
